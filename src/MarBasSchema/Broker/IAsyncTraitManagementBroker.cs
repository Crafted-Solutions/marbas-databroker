...
namespace CraftedSolutions.MarBasSchema.Broker
{
    public interface IAsyncTraitManagementBroker
    {
        ...
        Task<IEnumerable<IGrainLocalized>> LookupGrainsByTraitAsync(ITraitRef traitRef, object? value = null, FieldCompareOperator compareOperator = FieldCompareOperator.Eq, IEnumerable<IListSortOption<GrainSortField>>? sortOptions = null, CancellationToken cancellationToken = default);
    }
}
