...
namespace CraftedSolutions.MarBasSchema.Broker
{
    public interface ITraitManagementBroker
    {
        ...
        IEnumerable<IGrainLocalized> LookupGrainsByTrait(ITraitRef traitRef, object? value = null, FieldCompareOperator compareOperator = FieldCompareOperator.Eq, IEnumerable<IListSortOption<GrainSortField>>? sortOptions = null);
    }
}
